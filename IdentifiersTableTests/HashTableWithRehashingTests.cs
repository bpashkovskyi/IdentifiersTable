...
{
    public class HashTableWithRehashingTests
    {
        [Fact]
        public void HashTableWithRehashingShouldReturnCorrectValues()
        {
            var hashTableWithRehashing = new HashTableWithRehashing();
